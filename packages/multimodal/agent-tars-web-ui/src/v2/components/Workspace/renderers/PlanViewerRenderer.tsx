  ...
  if (!plan.hasGeneratedPlan || steps.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center h-full p-6 text-center">
        ...
        <h3 className="text-lg font-medium text-gray-700 dark:text-gray-300 mb-2">No plan generated</h3>
        <p className="text-gray-500 dark:text-gray-400 max-w-md">
          The agent hasn't created a plan for this task yet, or the task was simple enough to not require a plan.
        </p>
      </div>
    );
  }
    ...
    <div className="p-6 h-full flex flex-col">
      ...
      <div className="mb-6">
        <h2 className="text-xl font-bold text-gray-800 dark:text-gray-200 mb-2 flex items-center">
          <FiTarget className="mr-3 text-gray-600 dark:text-gray-400" size={20} />
          Agent Plan
        </h2>
      ...
      {keyframes && keyframes.length > 1 && (
        <div className="mb-6">
          <div className="flex items-center justify-between mb-2">
            <div className="text-sm font-medium text-gray-700 dark:text-gray-300">Plan Timeline</div>
          ...
          {steps.map((step, index) => (
            <div key={index} className="relative">
              ...
              <div className="flex items-start gap-4">
                <div className={`flex-shrink-0 w-10 h-10 rounded-full flex items-center justify-center text-white transition-all duration-300 ${
                  step.done 
                    ? 'bg-accent-500 dark:bg-accent-400 shadow-sm' 
