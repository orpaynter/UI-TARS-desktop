  ...
  return (
    ...
    >
      ...
      <div className="bg-gray-100 dark:bg-gray-800/90 border-b border-gray-200/80 dark:border-gray-700/40">
        {/* Tab bar */}
        <div className="flex items-center border-b border-gray-200/50 dark:border-gray-700/30 px-2 py-1">
          <div className="flex items-center bg-white dark:bg-gray-700/70 rounded-t-lg px-3 py-1 border-b-0 border border-gray-200/70 dark:border-gray-700/40 text-xs text-gray-700 dark:text-gray-300 max-w-[200px] truncate">
            <div className="w-2 h-2 rounded-full bg-gray-300 dark:bg-gray-600 mr-2" />
