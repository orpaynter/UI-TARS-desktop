    ...
    <div className="relative markdown-wrapper text-sm">
      <ReactMarkdown
        components={{
          ...
          th({ children }) {
            return (
              <th className="p-2 text-left font-semibold border-r border-gray-200/40 dark:border-gray-700/20 last:border-0">
                {children}
              </th>
            );
          },
          td({ children }) {
            return (
              <td className="p-2 border-r border-gray-200/40 dark:border-gray-700/20 last:border-0">
                {children}
              </td>
            );
          },
