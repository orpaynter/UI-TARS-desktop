...
export const ConnectionStatusBar: React.FC = () => {
  ...
  return (
    <motion.div
      ...
      exit={{ opacity: 0, y: -20 }}
      className="mb-5 rounded-3xl overflow-hidden border-l-4 border-l-red-400 dark:border-l-red-600 
                 bg-gradient-to-r from-red-50/90 to-red-50/60 dark:from-red-900/15 dark:to-red-900/5 
      ...
      <div className="px-5 py-4 flex items-center">
        ...
        {!connectionStatus.reconnecting && (
          <motion.button
            ...
            className="ml-4 px-4 py-2 bg-red-100/80 dark:bg-red-800/20 hover:bg-red-200/80 dark:hover:bg-red-700/30 rounded-xl text-sm font-medium transition-colors"
          >
            Retry Connection
          </motion.button>
        )}
